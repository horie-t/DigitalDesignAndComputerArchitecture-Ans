...
module Mips
  (input logic clk, reset, 	// クロック、リセット
   ...
   Controller c(opField, functField, programCounterWriteEnable, instrOrDataAddress, instrReadEnable,
		regFileWriteEnable, regDstFieldSel, aluSrcASel, aluSrcBSel, aluControl, aluResultZero);
